    ...
    <body onload="afterwards()">
        <div class="bgimg grid-container">
            ...
            <div class="gp1 w3-animate-left toggle-buttons">
                ...
                <input type="radio" name="pfach1" id="pfach1.1" value="Mathe" onclick="selected('pfach1.', '1'), visible('pfach1.', '1'), save(), logicvariables(), change_kf_text_lang(), logicsubjects(1), proof_in_advance('pfach2.', 2)">
                <label for="pfach1.1" title="Kernfach, Bereich C" id="pfach1.1.label">Mathe</label>
                <br>
                <br>
                <input type="radio" name="pfach1" id="pfach1.2" value="Chemie" onclick="selected('pfach1.', '2'), visible('pfach1.', '2'), save(), logicvariables(), change_kf_text_lang(), logicsubjects(1), proof_in_advance('pfach2.', 2)">
                <label for="pfach1.2" title="kein Kernfach, Bereich C" id="pfach1.2.label">Chemie</label>
                <br>
                <br>
                <input type="radio" name="pfach1" id="pfach1.3" value="Englisch" onclick="selected('pfach1.', '3'), visible('pfach1.', '3'), save(), logicvariables(), change_kf_text_lang(), logicsubjects(1), proof_in_advance('pfach2.', 2)">
                <label for="pfach1.3" title="Kernfach, Bereich A" id="pfach1.3.label">Englisch</label>
                <br>
                <br>
                <input type="radio" name="pfach1" id="pfach1.4" value="Physik" onclick="selected('pfach1.', '4'), visible('pfach1.', '4'), save(), logicvariables(), change_kf_text_lang(), logicsubjects(1), proof_in_advance('pfach2.', 2)">
                <label for="pfach1.4" title="kein Kernfach, Bereich C" id="pfach1.4.label">Physik</label>
                <br>
                <br>
                <input type="radio" name="pfach1" id="pfach1.5" value="Biologie" onclick="selected('pfach1.', '5'), visible('pfach1.', '5'), save(), logicvariables(), change_kf_text_lang(), logicsubjects(1), proof_in_advance('pfach2.', 2)">
                <label for="pfach1.5" title="kein Kernfach, Bereich C" id="pfach1.5.label">Biologie</label>
                <br>
                <br>
                <input type="radio" name="pfach1" id="pfach1.6" value="Französisch" onclick="selected('pfach1.', '5'), selected('pfach1.', '6'), visible('pfach1.', '6'), save(), logicvariables(), change_kf_text_lang(), logicsubjects(1), proof_in_advance('pfach2.', 2)">
                <label for="pfach1.6" title="Kernfach, Bereich A" id="pfach1.6.label">Französisch</label>
                <br>
                <br>
                <input type="radio" name="pfach1" id="pfach1.7" value="Latein" onclick="selected('pfach1.', '5'), selected('pfach1.', '7'), visible('pfach1.', '7'), save(), logicvariables(), change_kf_text_lang(), logicsubjects(1), proof_in_advance('pfach2.', 2)">
                <label for="pfach1.7" title="Kernfach, Bereich A" id="pfach1.7.label">Latein</label>
                <br>
                <br>
                <input type="radio" name="pfach1" id="pfach1.8" value="Musik" onclick="selected('pfach1.', '5'), selected('pfach1.', '8'), visible('pfach1.', '8'), save(), logicvariables(), change_kf_text_lang(), logicsubjects(1), proof_in_advance('pfach2.', 2)">
                <label for="pfach1.8" title="kein Kernfach, Bereich A" id="pfach1.8.label">Musik</label>
                <br>
                <br>
                <input type="radio" name="pfach1" id="pfach1.9" value="Informatik" onclick="selected('pfach1.', '5'), selected('pfach1.', '9'), visible('pfach1.', '9'), save(), logicvariables(), change_kf_text_lang(), logicsubjects(1), proof_in_advance('pfach2.', 2)">
                <label for="pfach1.9" title="kein Kernfach, Bereich C" id="pfach1.9.label">Informatik</label>
                <br>
                <br>
                <input type="radio" name="pfach1" id="pfach1.10" value="Kunst" onclick="selected('pfach1.', '10'), visible('pfach1.', '10'), save(), logicvariables(), change_kf_text_lang(), logicsubjects(1), proof_in_advance('pfach2.', 2)">
                <label for="pfach1.10" title="kein Kernfach, Bereich A" id="pfach1.10.label">Kunst</label>
                <br>
                <br>
                <input type="radio" name="pfach1" id="pfach1.11" value="Spanisch" onclick="selected('pfach1.', '11'), visible('pfach1.', '11'), save(), logicvariables(), change_kf_text_lang(), logicsubjects(1), proof_in_advance('pfach2.', 2)">
                <label for="pfach1.11" title="Kernfach, Bereich A" id="pfach1.11.label">Spanisch</label>
                <br>
                <br>
                <input type="radio" name="pfach1" id="pfach1.12" value="Deutsch" onclick="selected('pfach1.', '12'), visible('pfach1.', '12'), save(), logicvariables(), change_kf_text_lang(), logicsubjects(1), proof_in_advance('pfach2.', 2)">
                <label for="pfach1.12" title="Kernfach, Bereich A" id="pfach1.12.label">Deutsch</label>
                <br>
                <br>
                <input type="radio" name="pfach1" id="pfach1.13" value="Geschichte" onclick="selected('pfach1.', '13'), visible('pfach1.', '13'), save(), logicvariables(), change_kf_text_lang(), logicsubjects(1), proof_in_advance('pfach2.', 2)">
