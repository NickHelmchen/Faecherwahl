...
<html>
    ...
    <body onload="page2(), logicvariables(), afterwards()">
...
Hier tauchen die Infos zu Kernfächern und den Bereichen auf.
            ...
            <form action='../includes/logout.inc.php' class='logoutbutton' method='post'>
                <button type='submit' name='submit' class='logoutbutton1 buttonfertig'>logout</button>
            </form>
            ...
            <button onclick="restart(), terminator(), logicvariables()" id="restart" class="buttonfertig restartbutton next-button">neu wählen</button>
