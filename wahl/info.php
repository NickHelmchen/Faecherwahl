...
<html lang="de">
  ...
  <head>
    ...
    <script>
      function nicht_waehlen_reset(){
        sessionStorage.setItem('nicht_waehlen_Fach', 'dummy')
        sessionStorage.removeItem('nicht_waehlen_Fach')
      }
    </script>
  </head>

  <body class="bgimg" onload="terminator(), url(), nicht_waehlen_reset()">
    <div class="grid-container1">
      <?php 
      echo '<textarea name="name" id="name" cols="20" rows="1" class="head-input1" readonly>' . $_SESSION['userName'] . '</textarea>'
      ?>
