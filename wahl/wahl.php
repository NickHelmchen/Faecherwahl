...
<html>
    <head>
        ...
        function nicht_waehlen_check() {
            switch (sessionStorage.getItem('nicht_waehlen_Fach')) {
                case 'mathe_w':
                    document.getElementById('pfach1.1.label').style.opacity = '0.5'
                    document.getElementById('pfach1.1').disabled = true
                    break;
                case 'chemie_w':
                    document.getElementById('pfach1.2.label').style.opacity = '0.5'
                    document.getElementById('pfach1.2').disabled = true
                    break;
                case 'englisch_w':
                    document.getElementById('pfach1.3.label').style.opacity = '0.5'
                    document.getElementById('pfach1.3').disabled = true
                    break;
                case 'physik_w':
                    document.getElementById('pfach1.4.label').style.opacity = '0.5'
                    document.getElementById('pfach1.4').disabled = true
                    break;
                case 'biologie_w':
                    document.getElementById('pfach1.5.label').style.opacity = '0.5'
                    document.getElementById('pfach1.5').disabled = true
                    break;
                case 'franzoesisch_w':
                    document.getElementById('pfach1.6.label').style.opacity = '0.5'
                    document.getElementById('pfach1.6').disabled = true
                    break;
                case 'latein_w':
                    document.getElementById('pfach1.7.label').style.opacity = '0.5'
                    document.getElementById('pfach1.7').disabled = true
                    break;
                case 'musik_w':
                    document.getElementById('pfach1.8.label').style.opacity = '0.5'
                    document.getElementById('pfach1.8').disabled = true
                    break;
                case 'informatik_w':
                    document.getElementById('pfach1.9.label').style.opacity = '0.5'
                    document.getElementById('pfach1.9').disabled = true
                    break;
                case 'kunst_w':
                    document.getElementById('pfach1.10.label').style.opacity = '0.5'
                    document.getElementById('pfach1.10').disabled = true
                    break;
                case 'spanisch_w':
                    document.getElementById('pfach1.11.label').style.opacity = '0.5'
                    document.getElementById('pfach1.11').disabled = true
                    break;
                case 'deutsch_w':
                    document.getElementById('pfach1.12.label').style.opacity = '0.5'
                    document.getElementById('pfach1.12').disabled = true
                    break;
                case 'geschichte_w':
                    document.getElementById('pfach1.13.label').style.opacity = '0.5'
                    document.getElementById('pfach1.13').disabled = true
                    break;
                default:
                    break;
            }
    ...
    <body onload="logicvariables(), afterwards(), nicht_waehlen_check()">
...
Hier tauchen die Infos zu Kernfächern und den Bereichen auf.
            ...
            <form action='../includes/logout.inc.php' method='post'>
                <button type='submit' name='submit' class='logoutbutton buttonfertig next-button'>logout</button>
            </form>
            ...
            <button onclick="restart(), terminator(), logicvariables(), nicht_waehlen_check()" id="restart" class="buttonfertig restartbutton next-button">neu wählen</button>
            ...
            <div class="gp4 w3-animate-top toggle-buttons">
                ...
                <br>
                <br>
                <input type="radio" name="pfach4" id="pfach4.16" value="Erdkunde" onclick="selected('pfach4.', '16'), visible('pfach4.', '16'), save(), change_kf_text_lang(), disable_buttons_p(4), logicsubjects(4), show_kf_abc(), proof_in_advance('pfach5.', 5)">
            ...
            <div class="gp5 w3-animate-right toggle-buttons">
                ...
                <br>
                <br>
                <input type="radio" name="pfach5" id="pfach5.17" value="Sport" onclick="selected('pfach5.', '17'), visible('pfach5.', '17'), save(), change_kf_text_lang(), disable_buttons_p(5), logicsubjects(5), show_kf_abc()">
