...
<html lang="de">
  ...
  <body onload="check_for_pfaecher_gewaehlt(), muku()">
    <div class="bgimg grid-container4">
        ...
        <button class="reset4 buttonfertig" onclick="uncheck_reset_gk_muku()" id="resetbutton">Grundkurse zurücksetzen</button>
        <button class="reset-p-4 buttonfertig" onclick="go_back()" id="resetbutton2">Prüfungsfächer neu wählen</button>
        ...
        <div class="natu4-2 w3-animate-bottom toggle-buttons" title="Hier kannst du einen Wunsch angeben, welches Fach du vielleicht noch als P4 oder P5 festlegen möchtest und daher im 12. Jahrgang belegen möchtest">
          ...
          <input type="radio" name="extra7" id="Geschichte2" onclick="set_wish('Geschichte')">
          <label for="Geschichte2" id="Geschichte2.label">Geschichte</label> 
          <br>
          <br>
          <input type="radio" name="extra7" id="PoWi2" onclick="set_wish('Politik Wirtschaft')">
          <label for="PoWi2" id="PoWi2.label">Politik Wirtschaft</label> 
          <br>
          <br>
          <input type="radio" name="extra7" id="Religion2" onclick="set_wish('Religion')">
